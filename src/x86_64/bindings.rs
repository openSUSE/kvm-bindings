    ...
    Storage: std::default::Default,
{
    ...
    fn deserialize<R: std::io::Read>(
        ...
        let __default : __BindgenBitfieldUnit<Storage> = Default::default();
        Ok(__default)
    }
...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialEq, Serialize, Deserialize, Versionize)]
...
#[repr(C)]
#[derive(Copy, Clone, Serialize, Deserialize, Versionize)]
...
impl Serialize for kvm_ioapic_state__bindgen_ty_1 {
    ...
    where
        S: serde::Serializer,
    {
        // SAFETY: Safe because this is a POD object and we're only using the read result to
...
impl<'de> Deserialize<'de> for kvm_ioapic_state__bindgen_ty_1 {
    ...
    {
        let bits: __u64 = Deserialize::deserialize(deserializer)?;
        assert_eq!(std::mem::size_of_val(&bits), std::mem::size_of::<Self>());
        Ok(Self { bits })
    }
}
...
#[repr(C)]
#[derive(Debug, Default, Serialize, Deserialize, Versionize)]
pub struct kvm_msrs {
    pub nmsrs: __u32,
    pub pad: __u32,
...
// Helper struct for the manual `Serialize, Deserialize, Versionize` implementation below. This makes things easier,
...
impl Serialize for kvm_irqchip__bindgen_ty_1 {
        ...
        S: serde::Serializer,
    {
        ...
        serde::Serialize::serialize(&dummy, serializer)
    }
}
...
impl<'de> Deserialize<'de> for kvm_irqchip__bindgen_ty_1 {
    ...
    where
        D: serde::Deserializer<'de>,
    {
        let dummy: kvm_irqchip__bindgen_ty_1_dummy = Deserialize::deserialize(deserializer)?;
        assert_eq!(std::mem::size_of_val(&dummy), std::mem::size_of::<Self>());
